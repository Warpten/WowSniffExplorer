...
namespace SniffExplorer.Reactive
{
    /// <summary>
    ...
    public class DispatcherScheduler : LocalScheduler, ISchedulerPeriodic
    {
        ...
        public static DispatcherScheduler Current
        {
            get
            {
                ...
                if (dispatcher == null)
                {
                    throw new InvalidOperationException("No dispatcher on the current thread");
                }
        ...
        private IDisposable ScheduleSlow<TState>(TState state, TimeSpan dueTime, Func<IScheduler, TState, IDisposable> action)
        {
            ...
            static IDisposable emptyDisposable(IScheduler s, TState state) => Disposable.Empty;
        ...
        public IDisposable SchedulePeriodic<TState>(TState state, TimeSpan period, Func<TState, TState> action)
        {
            ...
            static TState discard(TState state) => state;
